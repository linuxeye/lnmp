...
if [ `getconf WORD_BIT` == 32 ] && [ `getconf LONG_BIT` == 64 ] ;then
        if [ "$PHP_version" == '5.6' ];then
                src_url=http://mirrors.linuxeye.com/lnmp/srczend-loader-php5.6-linux-x86_64.tar.gz && Download_src
        ...
        if [ "$PHP_version" == '5.5' ];then
                src_url=http://mirrors.linuxeye.com/lnmp/srczend-loader-php5.5-linux-x86_64.tar.gz && Download_src
	...
	if [ "$PHP_version" == '5.4' ];then
		src_url=http://mirrors.linuxeye.com/lnmp/srcZendGuardLoader-70429-PHP-5.4-linux-glibc23-x86_64.tar.gz && Download_src
	...
	if [ "$PHP_version" == '5.3' ];then
		src_url=http://mirrors.linuxeye.com/lnmp/srcZendGuardLoader-php-5.3-linux-glibc23-x86_64.tar.gz && Download_src
        ...
        if [ "$PHP_version" == '5.6' ];then
                src_url=http://mirrors.linuxeye.com/lnmp/srczend-loader-php5.6-linux-i386.tar.gz && Download_src
        ...
        if [ "$PHP_version" == '5.5' ];then
                src_url=http://mirrors.linuxeye.com/lnmp/srczend-loader-php5.5-linux-i386.tar.gz && Download_src
        ...
        if [ "$PHP_version" == '5.4' ];then
		src_url=http://mirrors.linuxeye.com/lnmp/srcZendGuardLoader-70429-PHP-5.4-linux-glibc23-i386.tar.gz && Download_src
        ...
        if [ "$PHP_version" == '5.3' ];then
		src_url=http://mirrors.linuxeye.com/lnmp/srcZendGuardLoader-php-5.3-linux-glibc23-i386.tar.gz && Download_src
