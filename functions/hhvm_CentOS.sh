...
src_url=http://mirrors.linuxeye.com/lnmp/srclibwebp-0.3.1-2.el6.remi.x86_64.rpm && Download_src
src_url=http://mirrors.linuxeye.com/lnmp/srchhvm-3.5.0-4.el6.x86_64.rpm && Download_src
