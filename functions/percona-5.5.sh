...
src_url=http://www.percona.com/redir/downloads/Percona-Server-5.5/Percona-Server-5.5.36-34.1/source/tarball/percona-server-5.5.36-34.1.tar.gz && Download_src
...
tar zxf percona-server-5.5.36-34.1.tar.gz
cd percona-server-5.5.36-34.1
