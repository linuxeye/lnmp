...
src_url=http://www.percona.com/redir/downloads/Percona-Server-5.6/LATEST/source/tarball/percona-server-5.6.21-69.0.tar.gz && Download_src
...
tar zxf percona-server-5.6.21-69.0.tar.gz 
...
OS_command
cd ..
/bin/rm -rf percona-server-5.6.21-69.0
cd ..
