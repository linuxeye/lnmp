...
src_url=http://www.percona.com/redir/downloads/Percona-Server-5.6/Percona-Server-5.6.16-64.1/source/tarball/percona-server-5.6.16-64.1.tar.gz && Download_src
