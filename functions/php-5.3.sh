...
[ -s "php-5.3.27.tar.gz" ] && echo "php-5.3.27.tar.gz found" || wget -c http://www.php.net/get/php-5.3.27.tar.gz/from/this/mirror
src_url=http://www.php.net/distributions/php-5.3.27.tar.gz && Download_src
...
elif [ "$Apache_version" == '1' -o "$Apache_version" == '2' ]
