...
[ -s "php-5.4.22.tar.gz" ] && echo "php-5.4.22.tar.gz found" || wget -c http://www.php.net/get/php-5.4.22.tar.gz/from/this/mirror
src_url=http://www.php.net/distributions/php-5.4.22.tar.gz && Download_src
