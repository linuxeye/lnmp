...
src_url=http://www.php.net/distributions/php-5.4.41.tar.gz && Download_src
...
patch -d php-5.4.41 -p0 < fpm-race-condition.patch
cd php-5.4.41
make clean
...
cd ..
[ -d "$php_install_dir" ] && /bin/rm -rf php-5.4.41 
cd ..
}
