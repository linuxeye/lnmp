...
src_url=http://www.php.net/distributions/php-5.4.39.tar.gz && Download_src
...
patch -d php-5.4.39 -p0 < fpm-race-condition.patch
cd php-5.4.39
make clean
