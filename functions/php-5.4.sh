...
[ -s "php-5.4.23.tar.gz" ] && echo "php-5.4.23.tar.gz found" || wget -c http://www.php.net/get/php-5.4.23.tar.gz/from/this/mirror
src_url=http://www.php.net/distributions/php-5.4.23.tar.gz && Download_src
...
patch -d php-5.4.23 -p0 < fpm-race-condition.patch
cd php-5.4.23
make clean
