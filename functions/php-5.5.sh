...
src_url=http://kr1.php.net/distributions/php-5.5.3.tar.gz && Download_src
...
--with-fpm-user=www --with-fpm-group=www --enable-opcache --enable-fpm --disable-fileinfo --with-mysql=$db_install_dir \
