...
[ -s "php-5.5.11.tar.gz" ] && echo "php-5.5.11.tar.gz found" || wget -c http://www.php.net/get/php-5.5.11.tar.gz/from/this/mirror
src_url=http://www.php.net/distributions/php-5.5.11.tar.gz && Download_src
...
patch -d php-5.5.11 -p0 < fpm-race-condition.patch
cd php-5.5.11
make clean
