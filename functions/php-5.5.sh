...
src_url=http://www.php.net/distributions/php-5.5.18.tar.gz && Download_src
...
patch -d php-5.5.18 -p0 < fpm-race-condition.patch
cd php-5.5.18
make clean
