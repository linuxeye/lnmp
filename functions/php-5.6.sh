...
src_url=http://www.php.net/distributions/php-5.6.9.tar.gz && Download_src
...
patch -d php-5.6.9 -p0 < fpm-race-condition.patch
cd php-5.6.9
make clean
...
cd ..
[ -d "$php_install_dir" ] && /bin/rm -rf php-5.6.9
cd ..
}
