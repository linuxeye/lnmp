...
src_url=http://downloads.sourceforge.net/project/phpmyadmin/phpMyAdmin/4.3.5/phpMyAdmin-4.3.5-all-languages.tar.gz && Download_src

tar xzf phpMyAdmin-4.3.5-all-languages.tar.gz
/bin/mv phpMyAdmin-4.3.5-all-languages $home_dir/default/phpMyAdmin
