...
if [ -f "objs/nginx" ];then
	...
	echo -e "`printf "%-40s" "add Virtual Hosts:"`\033[32m/root/lnmp/vhost.sh\033[0m"
	echo -e "`printf "%-40s" "add ngx_pagespeed Virtual Hosts:"`\033[32m/root/lnmp/vhost_ngx_pagespeed.sh\033[0m"
else
