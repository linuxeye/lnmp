...
echo "#                    Upgrade Nginx for LNMP                           #"
echo "# For more information Please visit http://blog.linuxeye.com/31.html  #"
echo "#######################################################################"

cd src
. ../options.conf
[ ! -e "$nginx_install_dir" -o -e "$nginx_install_dir/sbin/dso_tool" ] && echo -e "\033[31mThe Nginx is not installed on your system!\033[0m " && exit 1
get_char()
{
SAVEDSTTY=`stty -g`
stty -echo
